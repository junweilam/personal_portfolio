        ...
        <>
            {!darkToggle ? (
                ...
                <div className="min-h-screen w-full bg-gray-100 flex">
                    ...
                    {/* Contents */}
                    <div>
                        {/* If Home Navigation Toggled */}
                        {homeToggle ? (
                            <HomeNav mode={darkToggle} />
                        ) : (
                            <p></p>
                        )}
                        {/* If About Navigation Toggled */}
                        {aboutToggle ? (
                            <AboutNav />
                        ) : (
                            <p></p>
                        )}
                        {/* If Past Experiences Navigation Toggled */}
                        {pastToggle ? (
                            <PastNav />
                        ) : (
                            <p></p>
                        )}
                        {/* If Contact Navigation Toggled */}
                        {contactToggle ? (
                            <ContactNav />
                        ) : (
                            <p></p>
